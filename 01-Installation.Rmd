...
If you're working on a **university-managed computer** (HBS 2.88 or Mansfield Cooper 2.01) or accessing the course via *Citrix*, both R and RStudio (described below) should already be installed or can be accessed through the Software Centre. 
...
- Click on 'base' and then `Download R [Version Number] for Windows`. The current version is 4.2.1. 
...
All the data required for this sets of practicals are available on Blackboard under Course Content → [Week 8 to 12](https://online.manchester.ac.uk/webapps/blackboard/content/listContentEditable.jsp?content_id=_14414662_1&course_id=_74713_1&content_id=_14414667_1).
