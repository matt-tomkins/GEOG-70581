...
If you're working on a university-managed computer or accessing the course via *Citrix*, both R and RStudio (described below) can be accessed through the Software Centre. 
