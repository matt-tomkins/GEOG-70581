...
Create an R Script which does the following:
  ...
  > Finds the average daily river flow (m<sup>3</sup> per second) **for each month** and plot the result. 
...
A code solution to the formative task will be uploaded here on the Monday after the class (22/11/2021). 
