...
For Practical 2, we are also going to use `data.table`, `forcats` and `dplyr` for data management, and `MASS` and `viridis` for analysis/visualisation respectively. 
