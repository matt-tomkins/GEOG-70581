...
This practical is formative and as such will not count towards your final mark for GEOG 70581. However, you are encouraged to complete the practical to the best of your ability as the skills developed here will be used throughout the assessed Practical 2. As with the [Introduction to R practical](#formative_solution_one), I will upload a code solution after the class so you can check your working. 
