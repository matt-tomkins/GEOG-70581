...
If you've not already done so, the data for this practical can be downloaded [here](https://canvas.manchester.ac.uk/courses/40307/pages/instructions-and-data?module_item_id=2105256). The directory structure is outlined in [Chapter 2](#materials). 
