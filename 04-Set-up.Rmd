...
The data for this practical can be downloaded [here](XXXX). The directory structure is outlined in [Chapter 2](#materials). 
...
For both Practicals 1 and 2, we are going to expand on these by also utilising **R projects**. Projects make life simpler by allowing us to access file locations (e.g. loading and writing data) using **relative** file paths, rather than using the clunky and prone-to-breaking **absolute** file paths.  
